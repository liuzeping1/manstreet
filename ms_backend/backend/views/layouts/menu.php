...
<div class="leftnav">
    ...
    <ul style="display:none">
        <li><a href="<?php echo Url::toRoute(['bowen/index']);?>"><span class="icon-caret-right"></span>商品展示</a></li>
    ...
    <ul style="display:none">
        <li><a href="<?php echo Url::toRoute(['category/index']);?>"><span class="icon-caret-right"></span>分类展示</a></li>
        <li><a href="<?php echo Url::toRoute(['category/add']);?>"><span class="icon-caret-right"></span>分类添加</a></li>
    </ul>
    ...
    <ul style="display:none">
        ...
        <li><a href="<?php echo Url::toRoute(['bowen/index']);?>"><span class="icon-caret-right"></span>订单列表</a></li>
    </ul>
    ...
    <ul style="display:none">
        ...
        <li><a href="<?php echo Url::toRoute(['bowen/index']);?>"><span class="icon-caret-right"></span>相册展示</a></li>
    </ul>
    <h2><span class="icon-pencil-square-o"></span>形象设计管理</h2>
    <ul style="display:none">

        <li><a href="<?php echo Url::toRoute(['bowen/index']);?>"><span class="icon-caret-right"></span>预约管理</a></li>
        <li><a href="<?php echo Url::toRoute(['bowen/index']);?>"><span class="icon-caret-right"></span>订单详情</a></li>
    </ul>
