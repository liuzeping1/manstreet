...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        ...
        <form method="post" class="form-x" action="?r=goods/amend" enctype="multipart/form-data">
            <div class="form-x">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="<?php echo $tr['goods_name']?>" name="goods_name" data-validate="required:请输入商品名称" />
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="<?php echo $tr['goods_price']?>" name="goods_price" data-validate="required:请输入商品价格" />
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="<?php echo $tr['goods_number']?>" name="goods_number" data-validate="required:请输入商品数量" />
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="<?php echo $tr['goods_sn']?>" name="goods_sn" data-validate="required:请输入商品货号" />
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="<?php echo $tr['sort']?>" name="sort" data-validate="required:请输入商品排序" />
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea class="input" name="goods_brief" style=" height:90px;"><?php echo $tr['goods_brief']?></textarea>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <div>
                            ...
                            <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="goods_desc"><?php echo $tr['goods_desc']?></script>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="hidden" name="goods_id" value="<?php echo $tr['goods_id']?>">
