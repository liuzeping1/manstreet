        ...
        <div class="col-md-4 products-left">
            ...
            <div class="new-products animated wow slideInUp" data-wow-delay=".5s">
                ...
                <div class="new-products-grids">
                    <?php foreach($hotGoods as $hotkey): ?>
                    <div class="new-products-grid">
                        <div class="new-products-grid-left">
                            <a href="cate_order?goods_id=<?php echo $hotkey['goods_id'] ?>"><img src="../../manstreet/ms_backend/backend/web/<?php echo $hotkey['goods_img'] ?>" alt=" " class="img-responsive" /></a>
                        </div>
                        <div class="new-products-grid-right">
                            <h4><a href="single.html"><?php echo $hotkey['goods_name'] ?></a></h4>
                            <div class="rating">
                                <div class="rating-left">
                                    <img src="../../manstreet/ms_backend/backend/web/<?php echo $hotkey['goods_img'] ?>" alt=" " class="img-responsive">
                                </div>
                                <div class="clearfix">
                                </div>
                            </div>
                            <div class="simpleCart_shelfItem new-products-grid-right-add-cart">
                                <p><span class="item_price"><?php echo $hotkey['goods_price'] ?>&nbsp;&nbsp;RMB</span><a class="item_add0" value="<?php echo $hotkey['goods_id'] ?>" href="javascript:void(0);">产品详情 </a></p>
                            </div>
                        </div>
                ...
                <div class="col-md-4 products-right-grids-bottom-grid">
                    <div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
                        <div class="new-collections-grid1-image">
                            <a href="single.html" class="product-image"><img src="../../manstreet/ms_backend/backend/web/<?php echo $goodskey['goods_img'] ?>" width="190px" height="190px" alt=" " class="img-responsive"></a>
                            <div class="new-collections-grid1-image-pos products-right-grids-pos">
                                <a href="cate_order?goods_id=<?php echo $goodskey['goods_id'] ?>">产品详情</a>
                            </div>
                        ...
                        <h4><a href="single"><?php echo $goodskey['goods_name'] ?></a></h4>
