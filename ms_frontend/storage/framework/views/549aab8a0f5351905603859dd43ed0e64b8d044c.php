            ...
            <div class="col-md-3 new-collections-grid">
                ...
                <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s" style="float: left">
                    <div class="new-collections-grid1-image">
                        <a href="javascript:void (0)" class="product-image"><img src="../../manstreet/ms_backend/backend/web/<?php echo $v['goods_img'] ?>" alt=" " class="img-responsive" /></a>
                        <div class="new-collections-grid1-image-pos">
                            <a href="single">查看详情</a>
                        </div>
                    ...
                    <h4><a href="single"><?php echo $v['goods_name'] ?></a></h4>
                    <p><?php echo $v['goods_brief'] ?></p>
                    <div class="new-collections-grid1-left simpleCart_shelfItem">
                        <p><span class="item_price"><?php echo $v['goods_price'] ?>&nbsp;&nbsp;RMB</span><a class="item_add" href="cart">查看详情 </a></p>
                    </div>
                </div>
                    <?php endforeach; ?>
            </div>
