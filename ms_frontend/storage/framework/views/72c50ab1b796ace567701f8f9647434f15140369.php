    ...
    <div class="container">
        <div class="col-md-4 products-left">
            <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
                <a href="single.html"><img src="<?php echo $good['goods_img']?>" alt=" " class="img-responsive" /></a>
                ...
                <div class="flexslider">
                    <ul class="slides">
                        <?php foreach($img_path as $v): ?>
                            <li data-thumb="<?php echo e($v); ?> ">
                                <div class="thumb-image"> <img src="<?php echo e($v); ?> " data-imagezoom="true"
